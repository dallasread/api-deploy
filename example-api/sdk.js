...
var API = {
    ...
    hello: function hello(data, done) {
        $.ajax({
            method: 'get',
            url: 'http://api.api-deploy.com/hello',
            data: data,
            complete: done
        });
    },
    ...
    helloThere: function helloThere(data, done) {
        $.ajax({
            method: 'get',
            url: 'http://api.api-deploy.com/hello/there',
            data: data,
            complete: done
        });
    },
    helloWorld: function helloWorld(data, done) {
        $.ajax({
            method: 'patch',
            url: 'http://api.api-deploy.com/hello/world',
            data: data,
            complete: done
        });
    },
